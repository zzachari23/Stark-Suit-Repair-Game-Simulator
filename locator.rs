...
/** 
    Traits implemented for Nodes to make them comparable 
**/
...
impl<T: PartialOrd> PriorityQueue<T> for Vec<T> {
    ...
    **/
    ...
    /**
        ...
        property. Returns the deleted element in the form of an option. 
    ...
    **/
    ...
    /**
        ...
        if dequeue were called on the queue. Return the element in the form
...
/**
    Function determines which enemy Stark should battle and their coordinates.
    Two hashmaps are given for allies and enemies. Each maps a name to their 
    current coordinates. The allies hashmap will always have a name
    called "Stark" included.  Returns the name and coordinates of the enemy
    Stark will battle in the form of a 3-tuple.  
**/
